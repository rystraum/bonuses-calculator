...
export default function Handoff() {
  ...
  const printHeader = (
    <div className="mb-2 grid grid-cols-[1fr_auto] items-center gap-x-4 border-b pb-2">
      <span className="row-span-2 font-display text-lg font-semibold tracking-tight">{dist.name}</span>
  ...
  return (
    <div className="space-y-8 px-6 py-10 print:px-0 print:py-4">
      <div>
        ...
        <div className="grid grid-cols-[1fr_auto] items-center gap-x-4 border-b pb-3">
          <h1 className="row-span-2 font-display text-2xl font-semibold tracking-tight">{dist.name}</h1>
          <span className="text-xs text-muted-foreground">
            Generated by <span className="font-medium text-foreground">{user?.username}</span>
          </span>
          <span className="text-xs text-muted-foreground">
